...
+(void)searchVenuesNearByLatitude:(NSString *)location
					   accuracyLL:(NSNumber*)accuracyLL
						 altitude:(NSNumber*)altitude
					  accuracyAlt:(NSNumber*)accuracyAlt
							query:(NSString*)query
...
+(void)suggestCompletion:(NSNumber*)lat
               longitude:(NSNumber*)lon
                   llacc:(NSString*)llacc
                     alt:(NSString*)alt
                  altAcc:(NSString *)altacc
                   query:(NSString*)query
                   limit:(NSString *)limit
