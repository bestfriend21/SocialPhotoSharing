...
@property (nonatomic, strong) CPUImagePicture *sourcePicture1;
@property (nonatomic, strong) CPUImagePicture *sourcePicture2;
@property (nonatomic, strong) CPUImagePicture *sourcePicture3;
@property (nonatomic, strong) CPUImagePicture *sourcePicture4;
@property (nonatomic, strong) CPUImagePicture *sourcePicture5;

@property (nonatomic, strong) IFImageFilter *internalFilter;
@property (nonatomic, strong) CPUImagePicture *internalSourcePicture1;
@property (nonatomic, strong) CPUImagePicture *internalSourcePicture2;
@property (nonatomic, strong) CPUImagePicture *internalSourcePicture3;
@property (nonatomic, strong) CPUImagePicture *internalSourcePicture4;
@property (nonatomic, strong) CPUImagePicture *internalSourcePicture5;

@property (strong, readwrite) CPUImageView *cpuImageView;
@property (strong, readwrite) CPUImageView *cpuImageView_HD;
...
@property (nonatomic, strong) CPUImagePicture *stillImageSource;
@property (nonatomic, strong) AVCaptureStillImageOutput *stillImageOutput;

@property (nonatomic, strong) CPUImageMovieWriter *movieWriter;
...
@synthesize cpuImageView;
@synthesize cpuImageView_HD;
...
{
    UIImage *currentFilteredImage = [self.filter imageByFilteringImage:rawImage];
...
- (void)startRecordingMovie {
    ...
    self.movieWriter = [[CPUImageMovieWriter alloc] initWithMovieURL:[self fileURLForTempMovie] size:CGSizeMake(480.0f, 480.0f)];
...
- (void)cancelAlbumPhotoAndGoBackToNormal {
    ...
    /*
    [self.filter removeTarget:self.CPUImageView_HD];
    [self.filter addTarget:self.CPUImageView];
    ...
    */
    ...
    self.rawImage = nil;  
    self.cpuImageView_HD.hidden = YES;
...
- (void)switchToNewFilter {
    ...
    if (self.stillImageSource != nil) {
        ...
        self.cpuImageView_HD.hidden = NO;
        [self.filter addTarget:self.cpuImageView_HD];
        [self.stillImageSource processImage];
        
        if ( [self getFilteredImage] != nil ) {
            [[NSNotificationCenter defaultCenter] postNotificationName:@"updatedFilterImage" object:[self getFilteredImage]];
        }
    ...
    dispatch_async(prepareFilterQueue, ^{
        switch (type) {
            ...
            case IF_MAYFAIR_FILTER: {
                ...
                self.internalFilter = [[IFMayfairFilter alloc] init];
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"blackboard1024" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"overlayMap" ofType:@"png"]]];
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"mayfairColorOverlay" ofType:@"png"]]];
            ...
            case IF_AMARO_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"blackboard1024" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"overlayMap" ofType:@"png"]]];
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"amaroMap" ofType:@"png"]]];
                break;
            }
            ...
            case IF_RISE_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"blackboard1024" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"overlayMap" ofType:@"png"]]];
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"riseMap" ofType:@"png"]]];
            ...
            case IF_HUDSON_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"hudsonBackground" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"overlayMap" ofType:@"png"]]];
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"hudsonMap" ofType:@"png"]]];
            ...
            case IF_XPROII_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"xproMap" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"vignetteMap" ofType:@"png"]]];
            ...
            case IF_SIERRA_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"sierraVignette" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"overlayMap" ofType:@"png"]]];
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"sierraMap" ofType:@"png"]]];
            ...
            case IF_LOMOFI_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"lomoMap" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"vignetteMap" ofType:@"png"]]];                
            ...
            case IF_EARLYBIRD_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"earlyBirdCurves" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"earlybirdOverlayMap" ofType:@"png"]]];                
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"vignetteMap" ofType:@"png"]]]; 
                self.internalSourcePicture4 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"earlybirdBlowout" ofType:@"png"]]];                
                self.internalSourcePicture5 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"earlybirdMap" ofType:@"png"]]];                
            ...
            case IF_SUTRO_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"vignetteMap" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"sutroMetal" ofType:@"png"]]];                
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"softLight" ofType:@"png"]]]; 
                self.internalSourcePicture4 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"sutroEdgeBurn" ofType:@"png"]]];                
                self.internalSourcePicture5 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"sutroCurves" ofType:@"png"]]];                
            ...
            case IF_TOASTER_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"toasterMetal" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"toasterSoftLight" ofType:@"png"]]];                
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"toasterCurves" ofType:@"png"]]]; 
                self.internalSourcePicture4 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"toasterOverlayMapWarm" ofType:@"png"]]];                
                self.internalSourcePicture5 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"toasterColorShift" ofType:@"png"]]];                
            ...
            case IF_BRANNAN_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"brannanProcess" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"brannanBlowout" ofType:@"png"]]];                
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"brannanContrast" ofType:@"png"]]]; 
                self.internalSourcePicture4 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"brannanLuma" ofType:@"png"]]];                
                self.internalSourcePicture5 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"brannanScreen" ofType:@"png"]]];                
            ...
            case IF_INKWELL_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"inkwellMap" ofType:@"png"]]];
            ...
            case IF_WALDEN_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"waldenMap" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"vignetteMap" ofType:@"png"]]];            
            ...
            case IF_HEFE_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"edgeBurn" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"hefeMap" ofType:@"png"]]];                
                self.internalSourcePicture3 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"hefeGradientMap" ofType:@"png"]]]; 
                self.internalSourcePicture4 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"hefeSoftLight" ofType:@"png"]]];                
                self.internalSourcePicture5 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"hefeMetal" ofType:@"png"]]];                
            ...
            case IF_VALENCIA_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"valenciaMap" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"valenciaGradientMap" ofType:@"png"]]];                
            ...
            case IF_NASHVILLE_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"nashvilleMap" ofType:@"png"]]];
            ...
            case IF_1977_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"1977map" ofType:@"png"]]];
                self.internalSourcePicture2 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"1977blowout" ofType:@"png"]]];                
            ...
            case IF_LORDKELVIN_FILTER: {
                ...
                self.internalSourcePicture1 = [[CPUImagePicture alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"kelvinMap" ofType:@"png"]]];
                
                break;
            }
                
            case IF_WILLOW_FILTER: {
                self.internalFilter = [[IFWillowFilter alloc] init];
...
- (void)switchFilter:(IFFilterType)type {
    ...
    if ((self.rawImage != nil) && (self.stillImageSource == nil)) {
        ...
        [self.rotationFilter removeTarget:self.filter];
        self.stillImageSource = [[CPUImagePicture alloc] initWithImage:self.rawImage];
        [self.stillImageSource addTarget:self.filter];
    } else {
...
- (id)initWithSessionPreset:(NSString *)sessionPreset cameraPosition:(AVCaptureDevicePosition)cameraPosition highVideoQuality:(BOOL)isHighQuality {
    ...
    rotationFilter = [[IFRotationFilter alloc] initWithRotation:kCPUImageRotateRight];
    ...
    cpuImageView = [[CPUImageView alloc] initWithFrame:CGRectMake(0, 45, 320, 320)];
    if (isHighQuality == YES) {
        cpuImageView.layer.contentsScale = 2.0f;
    } else {
        cpuImageView.layer.contentsScale = 1.0f;
    }
    [filter addTarget:cpuImageView];

    cpuImageView_HD = [[CPUImageView alloc] initWithFrame:[cpuImageView bounds]];
    cpuImageView_HD.hidden = YES;
    [cpuImageView addSubview:cpuImageView_HD];
