...
@interface CPUImageMovieWriter ()
{
    GLuint movieFramebuffer, movieRenderbuffer;
    
    CLProgram *colorSwizzlingProgram;
...
@implementation CPUImageMovieWriter
...
- (id)initWithMovieURL:(NSURL *)newMovieURL size:(CGSize)newSize;
{
    ...
    colorSwizzlingProgram = [[CLProgram alloc] initWithVertexShaderString:kGPUImageVertexShaderString fragmentShaderString:kGPUImageColorSwizzlingFragmentShaderString];
