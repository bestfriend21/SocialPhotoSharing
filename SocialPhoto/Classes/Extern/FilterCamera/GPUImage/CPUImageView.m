...
@interface CPUImageView () 
{
    GLuint inputTextureForDisplay;
    GLint backingWidth, backingHeight;
    GLuint displayRenderbuffer, displayFramebuffer;
    
    CLProgram *displayProgram;
...
- (void)commonInit;
{
    ...
    displayProgram = [[CLProgram alloc] initWithVertexShaderString:kGPUImageVertexShaderString fragmentShaderString:kGPUImageDisplayFragmentShaderString];
...
- (void)createDisplayFramebuffer;
{
	...
	[[[CPUImageOpenGLESContext sharedImageProcessingOpenGLESContext] context] renderbufferStorage:GL_RENDERBUFFER fromDrawable:(CAEAGLLayer*)self.layer];
...
{
    glBindRenderbuffer(GL_RENDERBUFFER, displayRenderbuffer);
    [[CPUImageOpenGLESContext sharedImageProcessingOpenGLESContext] presentBufferForDisplay];
}
