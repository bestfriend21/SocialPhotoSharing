...
@implementation CPUImageOpenGLESContext
...
+ (CPUImageOpenGLESContext *)sharedImageProcessingOpenGLESContext;
{
    ...
    static CPUImageOpenGLESContext *sharedImageProcessingOpenGLESContext = nil;
    
    dispatch_once(&pred, ^{
        sharedImageProcessingOpenGLESContext = [[CPUImageOpenGLESContext alloc] init];
    });
...
{
    [EAGLContext setCurrentContext:[[CPUImageOpenGLESContext sharedImageProcessingOpenGLESContext] context]];
}
...
- (EAGLContext *)context;
{
    if (context == nil)
    {
        ...
        context = [[EAGLContext alloc] initWithAPI:kEAGLRenderingAPIOpenGLES2 sharegroup:imageProcessingContext.sharegroup];
