...
- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    filterProgram = [[CLProgram alloc] initWithVertexShaderString:kGPUImageVertexShaderString fragmentShaderString:fragmentShaderString];
...
{
    CPUImagePicture *stillImageSource = [[CPUImagePicture alloc] initWithImage:imageToFilter];
