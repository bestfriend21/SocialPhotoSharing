...
- (id)initWithTableView:(UITableView *)tableView cancelButton:(BOOL)showButton {
    ...
    if (self) {
		...
		self.backgroundColor = [UIColor colorWithRed:210.0f/255.0f green:210.0f/255.0f blue:210.0f/255.0f alpha:1.0];
		
		// Create the photo border style
		self.photoborder = [[UIView alloc] initWithFrame:CGRectMake(10.0, 7.0, 40.0, 40.0)];
		self.photoborder.backgroundColor = [UIColor lightGrayColor];
		...
		self.progressLabel = [[UILabel alloc] initWithFrame:CGRectMake(56.0, 15, 225.0, 20.0)];
		...
		if (showButton) {
            ...
            [_loadIndicator setFrame:CGRectMake(278.0, 15.0, _loadIndicator.frame.size.width, _loadIndicator.frame.size.height)];
            /*
